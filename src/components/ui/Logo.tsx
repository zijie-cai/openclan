...
export const Logo: React.FC = () => {
  return (
    <div className="relative h-8 w-8 overflow-visible rounded-full">
      <svg 
      ...
      >
        ...
        <g>
          ...
          <g style={{ transformOrigin: '100px 95px', opacity: 1, transform: 'scale(1)' }}>
            ...
            <g fill="#FFFFFF" filter="url(#glow)">
              <path 
                style={{ transformOrigin: '65px 65px', opacity: 1, transform: 'scale(1) rotate(0deg)' }}
                d="M 65 59 Q 65 65 71 65 Q 65 65 65 71 Q 65 65 59 65 Q 65 65 65 59 Z" 
              />
              <path 
                style={{ transformOrigin: '135px 60px', opacity: 1, transform: 'scale(1) rotate(0deg)' }}
                d="M 135 54 Q 135 60 141 60 Q 135 60 135 66 Q 135 60 129 60 Q 135 60 135 54 Z" 
              />
              <path 
                style={{ transformOrigin: '100px 45px', opacity: 1, transform: 'scale(1) rotate(0deg)' }}
          ...
          <g 
            filter="url(#shadow)" 
            style={{ transformOrigin: '30px 110px', transform: 'rotate(-42deg)' }}
          >
